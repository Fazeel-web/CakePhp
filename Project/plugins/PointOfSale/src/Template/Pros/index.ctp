        ...
        <tbody>
            ...
            <tr>
                <div style="margin-bottom:40px;">
                    ...
                    <td style="padding-left:40px;"><?= h($pro->name) ?></td>
                    <td style="padding-left:40px;"><?= $this->Number->format($pro->price) ?></td>
                    <td style="padding-left:40px;"><?= $this->Number->format($pro->quantity) ?></td>
                    <td style="padding-left:40px;"><?= $this->Html->image( $pro->image, ['border' => '0', 'data-src' => $pro->image, 'class' => 'img-responsive','style'=>'width:200px; height:100px;']); ?></td>
                    <td style="padding-left:40px;"><?= $pro->has('category') ? $this->Html->link($pro->category->name, ['controller' => 'Categories', 'action' => 'view', $pro->category->id]) : '' ?></td>
