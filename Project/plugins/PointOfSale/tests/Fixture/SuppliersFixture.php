...
class SuppliersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'pro_id' => ['type' => 'integer', 'length' => 100, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            'pro_id' => ['type' => 'index', 'columns' => ['pro_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'suppliers_ibfk_1' => ['type' => 'foreign', 'columns' => ['pro_id'], 'references' => ['pros', 'id'], 'update' => 'restrict', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
